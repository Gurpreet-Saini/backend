    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CheckInReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/centers/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated center details",
                        "name": "center",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.StockUpdateReq"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/sewadars": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Sewadar details",
                        "name": "sewadar",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.Sewadar"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/sewadars/bulk-upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Center ID (for SuperAdmin)",
                        "name": "center_id",
                        "in": "formData"
                    }
                ],
        ...
        "/api/sewadars/transfer": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Transfer details (sewadar_id, department_id)",
                        "name": "transfer",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/sewadars/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated sewadar details",
                        "name": "sewadar",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/users": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "User details (username, password, role, center_id, department_id)",
                        "name": "user",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/users/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated user details (password, role, center_id, department_id)",
                        "name": "user",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "models.User": {
            ...
            "properties": {
                ...
                "department_id": {
                    "description": "scoped for operator/viewer",
                    "type": "integer"
                },
                "id": {
                    "type": "integer"
